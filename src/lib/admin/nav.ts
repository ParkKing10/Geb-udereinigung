import {
  LayoutDashboard, CalendarCheck, Inbox, KanbanSquare, Mail, Megaphone, ReceiptText, Wallet, Calculator, Newspaper, MonitorSmartphone, Settings, CircleUser, UserX, Users,
} from "lucide-react";
...
export const ADMIN_NAV: NavItem[] = [
  ...
  { label: "Abgebrochen", href: "/admin/abgebrochen", icon: UserX },
